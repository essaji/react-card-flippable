...
var DEFAULT_COLOR = "rgb(147, 204, 232)";

var CardFlippable = function (_Component) {
    _inherits(CardFlippable, _Component);

    function CardFlippable() {
        _classCallCheck(this, CardFlippable);

        var _this = _possibleConstructorReturn(this, (CardFlippable.__proto__ || Object.getPrototypeOf(CardFlippable)).call(this));

        _this.state = { isFlipped: false };
        return _this;
    }

    _createClass(CardFlippable, [{
        key: 'toggleCard',
        value: function toggleCard() {
            if (this.props.cardId === this.props.activeCardId) return this.setState({ isFlipped: !this.state.isFlipped });
        ...
        value: function render() {
            ...
            if (thumbnailUrl) bgImageStyle["backgroundImage"] = 'url(' + thumbnailUrl + ')';else bgImageStyle["backgroundColor"] = DEFAULT_COLOR;

            var isFlipped = this.state.isFlipped;

            var backCardClasses = ['side', 'alef-card-back'].join(" ");
            var cardClasses = ["alef-card", isFlipped ? "flip-alef-card" : ""].join(" ");

            return _react2.default.createElement(
                'div',
                { className: 'alef-card-container' },
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        frontContent || _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { style: bgImageStyle, className: 'alef-card-bg' },
                                title ? _react2.default.createElement(
                                    'div',
                                    { className: 'alef-card-title' },
                                    title
                                ) : null
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'alef-card-info' },
                                _react2.default.createElement(
                                    'div',
                                    { className: 'alef-card-description' },
    ...
    return CardFlippable;
}(_react.Component);

exports.default = CardFlippable;
...
// module
exports.push([module.i, "\n.alef-card-container {\n    height: 260px;\n    perspective: 600px;\n    position: relative;\n}\n.alef-card {\n    cursor: pointer;\n    position: absolute;\n    transform-style: preserve-3d;\n    transition: all 300ms ease-in;\n    height: 100%;\n    width: 230px;\n    box-shadow: 1px 1px 5px gray;\n}\n.alef-card-back {\n    text-align: center;\n    transform: rotateY(180deg);\n    cursor: default;\n}\n\n\n.flip-alef-card {\n    transform: rotateY(180deg);\n    transition: all 300ms ease-in;\n}\n.alef-card .side {\n    backface-visibility: hidden;\n    position: absolute;\n    overflow: hidden;\n    width: 100%;\n    height:100%;\n}\n\n.alef-card-info {\n    background-color: white;\n    padding: 5px 13px;\n    height: 40%;\n}\n\n.alef-card-description {\n    font-size: 0.9em;\n}\n\n\n.alef-card-bg {\n    height: 150px;\n}\n\n.alef-card-title {\n    padding: 10px;\n    background-color: rgba(1,1,1,0.5);\n    color: white;\n}\n\n.alef-card-play-button {\n    height: 100px;\n    margin-top: 30%;\n}", ""]);
